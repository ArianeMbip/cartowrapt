namespace ApiCartobani.UnitTests.UnitTests.Domain.RolePermissions.Features;

using ApiCartobani.SharedTestHelpers.Fakes.RolePermission;
using ApiCartobani.Domain.RolePermissions;
using ApiCartobani.Domain.RolePermissions.Dtos;
using ApiCartobani.Domain.RolePermissions.Mappings;
using ApiCartobani.Domain.RolePermissions.Features;
using ApiCartobani.Domain.RolePermissions.Services;
using MapsterMapper;
