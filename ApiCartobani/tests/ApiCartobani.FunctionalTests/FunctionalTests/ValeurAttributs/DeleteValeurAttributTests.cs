...
public class DeleteValeurAttributTests : TestBase
{
    [Test]
    public async Task delete_valeurattribut_returns_nocontent_when_entity_exists()
    {
        // Arrange
        ...
        // Act
        var route = ApiRoutes.ValeurAttributs.Delete.Replace(ApiRoutes.ValeurAttributs.Id, fakeValeurAttribut.Id.ToString());
