...
public sealed class InterfaceUtilisateurConfiguration : IEntityTypeConfiguration<InterfaceUtilisateur>
{
    /// <summary>
    /// The database configuration for InterfacesUtilisateur. 
    /// </summary>
    public void Configure(EntityTypeBuilder<InterfaceUtilisateur> builder)
    {
