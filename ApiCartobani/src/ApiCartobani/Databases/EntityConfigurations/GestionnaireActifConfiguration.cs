...
public sealed class GestionnaireActifConfiguration : IEntityTypeConfiguration<GestionnaireActif>
{
    /// <summary>
    /// The database configuration for GestionnaireActif. 
    /// </summary>
    public void Configure(EntityTypeBuilder<GestionnaireActif> builder)
    {
