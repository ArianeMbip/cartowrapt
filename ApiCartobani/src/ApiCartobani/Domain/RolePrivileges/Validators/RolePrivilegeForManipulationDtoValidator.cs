...
public class RolePrivilegeForManipulationDtoValidator<T> : AbstractValidator<T> where T : RolePrivilegeForManipulationDto
{
    public RolePrivilegeForManipulationDtoValidator()
    {
