...
public class TypeElementForManipulationDtoValidator<T> : AbstractValidator<T> where T : TypeElementForManipulationDto
{
    public TypeElementForManipulationDtoValidator()
    {
