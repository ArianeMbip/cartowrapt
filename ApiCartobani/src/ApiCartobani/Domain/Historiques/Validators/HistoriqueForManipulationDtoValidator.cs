...
public class HistoriqueForManipulationDtoValidator<T> : AbstractValidator<T> where T : HistoriqueForManipulationDto
{
    public HistoriqueForManipulationDtoValidator()
    {
