...
public class PieceJointeForManipulationDtoValidator<T> : AbstractValidator<T> where T : PieceJointeForManipulationDto
{
    public PieceJointeForManipulationDtoValidator()
    {
