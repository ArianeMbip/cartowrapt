...
public class ComposantForManipulationDtoValidator<T> : AbstractValidator<T> where T : ComposantForManipulationDto
{
    public ComposantForManipulationDtoValidator()
    {
