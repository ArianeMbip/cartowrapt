...
public class InterfaceUtilisateurForManipulationDtoValidator<T> : AbstractValidator<T> where T : InterfaceUtilisateurForManipulationDto
{
    public InterfaceUtilisateurForManipulationDtoValidator()
    {
